...
export LX=/home/pdp7/dev/linux/.worktrees/single-bc-mbm
export BR=$HOME/dev/buildroot/output/images
export EDK=$HOME/dev/edk2
#export EDK=$HOME/dev/test/edk2/Build/RiscVVirtQemu/RELEASE_GCC/FV
build/qemu-system-riscv64 \
    ...
    -blockdev node-name=pflash1,driver=file,filename=$EDK/RISCV_VIRT_VARS-mbmtest.fd \
-drive if=none,file=${BR}/rootfs-mbmtest.ext2,format=raw,id=hd0 \
